...
typedef enum {
    ...
    OPERATOR_ASSIGN_MOD,
    OPERATOR_BITWISE_ASSIGN_AND,
    OPERATOR_BITWISE_ASSIGN_OR,
    OPERATOR_BITWISE_ASSIGN_XOR,
    OPERATOR_BITWISE_ASSIGN_LEFTSHIFT,
    OPERATOR_BITWISE_ASSIGN_RIGHTSHIFT,
    //ternary
    OPERATOR_TERNARY,
    //logical AND and OR
    OPERATOR_LOGICAL_OR,
    ...
    OPERATOR_LESS_THAN,
    OPERATOR_LESS_THAN_OREQ,
    OPERATOR_GREATER_THAN_OREQ,
    //shift
    OPERATOR_SHIFT_LOW,
